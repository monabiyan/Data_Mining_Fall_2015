...
To run the code in M09_Lesson_02.Rmd you may need additional packages.
...
# Assingment
  ...
  Answer the following questions:   
    * Can some form of bagging help in your research project?    
    * If it can apply bagging to your research project? Does it help?     
    * If (and only if) you can't use some form of bagging help in your research project then apply a form of bagging to the data set you chose for the supervised learning module. Does it help?       
