...
Q1) Can some form of Boosting help in your research project?    
    
    Yes, My research is about Actibvity Recognition (AR) using different classifiers, and of course Boosting Classification method could be a very good classifier for the AR problem. 
    
    
Q2) If it can apply Boosting to your research project? Does it help?       
...
true_rare(test1,ypred_boost1)
true_zero(test1,ypred_boost1)

```

Boosting does a very good job on classifying the activities based on the sensor data. In fact after Random Forrest and SVM, Boosting was the most successful classifier in my dataset. It worth to mention that Boosting had slightly better performance than bagging on the AR dataset.
