...
To run the code in M07_Lesson_03.Rmd you may need additional packages.
...
* Go to the [Self-Organising Maps for Customer Segmentation using R](http://www.r-bloggers.com/self-organising-maps-for-customer-segmentation-using-r/) via @rbloggers and complete the tutorial. Once you complete the tutorial you will answer questions about how the parameterization of the Self-Organixing Map affects the clustering.  
