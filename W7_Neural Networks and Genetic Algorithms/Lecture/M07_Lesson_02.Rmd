...
To run the code in M07_Lesson_02.Rmd you may need additional packages.
...
* Answer the following questions:
    * How does the genetic algorithm solution compare to the simulated annealing solution?  
    * How does the crossover probability effect the genetic algorithm solution?  
    * How does the mutation probability effect the genetic algorithm solution?     
