...
To run the code in M07_Lesson_01.Rmd you may need additional packages.
...
* . Answer the following questions:  
    * Write a different distance function. How does the effect the final solution?  
    * Does scaling, normalization or leaving the data unscaled make a difference for simulated annealing?  
    * Try a few differnt initial tours. How does the effect the final solution?    
